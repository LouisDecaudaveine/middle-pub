...
export const LONDON_GIS_API = {
  ...
  BASE_URL: 'https://gis2.london.gov.uk/server/rest/services/apps/Cultural_infrastructure_2023_for_webapp_verified/MapServer',
  
  /** Pubs layer ID */
  PUBS_LAYER_ID: 29,
  
  /** Query endpoint for pubs */
  PUBS_QUERY_URL: 'https://gis2.london.gov.uk/server/rest/services/apps/Cultural_infrastructure_2023_for_webapp_verified/MapServer/29/query',
...
export const LONDON_MAP_CONFIG = {
  ...
  MAX_BOUNDS: [
    [-0.510375, 51.286760], // Southwest coordinates
